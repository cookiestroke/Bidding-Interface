...
<div><br><Br>
	<div class="menu1" style="margin:auto;display: inline-block;width:100%;"><img src="img1.jpg" style="height:300px;width:300px;margin:30px;float:right;">
	
	<?php
	$mysqli = new mysqli("localhost", "root", "", "users");
	$result = $mysqli->query("SELECT * FROM pain WHERE painid=1001") or die($mysqli->error);
	...
	?>
	<form action="bid.php" style="float:right;margin-right:120px;margin-top:-70px;">Place Your Bid <input type="submit" id="input" value="&nbsp" style="border-radius: 45%;width:50px;height:50px;"></form>
	</div><br><Br><Br>
	<div class="menu1" style="margin:auto;display:inline-block;width:100%;"><img src="img2.jpg" style="height:300px;width:300px;margin:30px;float:right;">
	<?php
	$mysqli = new mysqli("localhost", "root", "", "users");
	$result = $mysqli->query("SELECT * FROM pain WHERE painid=1002") or die($mysqli->error);
	if ( $result->num_rows != 0 )
	{ // painting data
    while($paint = $result->fetch_assoc()) 
	{
	...
	<div class="menu1" style="margin:auto;display: inline-block;width:100%;"><img src="11.jpg" style="height:300px;width:300px;margin:30px;float:right;">
	
	<?php
	$mysqli = new mysqli("localhost", "root", "", "users");
	$result = $mysqli->query("SELECT * FROM pain WHERE painid=1003") or die($mysqli->error);
	if ( $result->num_rows != 0 )
	{ // painting data
    while($paint = $result->fetch_assoc()) 
	{
	...
	?>
	<form action="bid.php" style="float:right;margin-right:120px;margin-top:-70px;">Place Your Bid <input type="submit" value="&nbsp" id="input" style="border-radius: 45%;width:50px;height:50px;"></form>
	</div>
</div>
<br><br><br>
<p class="mes">Next Page</p>
<a class="next show" href="auction1.php" style="margin-left:50%;width:50px;margin-bottom:20px;margin-top:-20px;"><img src="arrow-r.png" style="width:50px;height:30px"></a><br><br>
