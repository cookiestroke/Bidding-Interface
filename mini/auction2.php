...
<div><br><Br>
	<div class="menu1" style="margin:auto;display: inline-block;width:100%;"><img src="19.jpg" style="height:300px;width:300px;margin:30px;float:right;">
	<?php
	$mysqli = new mysqli("localhost", "root", "", "users");
	$result = $mysqli->query("SELECT * FROM pain WHERE painid=1007") or die($mysqli->error);
	...
	?>
	<form action="bid.php" style="float:right;margin-right:120px;margin-top:-70px;">Place Your Bid <input type="submit" value="&nbsp;" id="input" style="border-radius: 45%;width:50px;height:50px;"></form>
	</div><br><Br><Br>
	<div class="menu1" style="margin:auto;display:inline-block;width:100%;"><img src="20.jpg" style="height:300px;width:300px;margin:30px;float:right;">
	<?php
	$mysqli = new mysqli("localhost", "root", "", "users");
	$result = $mysqli->query("SELECT * FROM pain WHERE painid=1008") or die($mysqli->error);
	if ( $result->num_rows != 0 )
	{ // painting data
    while($paint = $result->fetch_assoc()) 
	{
	...
	<div class="menu1" style="margin:auto;display: inline-block;width:100%;"><img src="img6.jpg" style="height:300px;width:300px;margin:30px;float:right;">
	
	<?php
	$mysqli = new mysqli("localhost", "root", "", "users");
	$result = $mysqli->query("SELECT * FROM pain WHERE painid=1009") or die($mysqli->error);
	if ( $result->num_rows != 0 )
	{ // painting data
    while($paint = $result->fetch_assoc()) 
	{
...
<br><br><br>
<p style="margin-left:49%;margin-top:0%;margin-bottom:2%;">Previous Page</p>
<a class="next" href="auction1.php" style="margin-left:50%;margin-bottom:20px;margin-top:-20px;width:50px;"><img src="arrow-l.png" style="width:50px;height:30px"></a>
<br><br>
